...
class SaleWorkflowProcess(models.Model):
    _name = "sale.workflow.process.custom"
    _description = "Sale Workflow Process Custom"
    ...
    create_invoice = fields.Boolean('Create & Validate Invoice', default=False,
                                    ...
                                    tracking=True)
    register_payment = fields.Boolean(default=False, help="If it's checked, Payment will be registered for Invoice or "
    ...
    picking_policy = fields.Selection([
        ...
        required=True,
        tracking=True)
    inbound_payment_method_id = fields.Many2one('account.payment.method',
                                            string="Debit Method",
