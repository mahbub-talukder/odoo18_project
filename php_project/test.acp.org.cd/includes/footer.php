    ...
    <div class="row">
      ...
      <div class="col-12 col-md-7 mb-4 mb-md-0">
        ...
        <p class="mini-paragraph">
          L'idéologie de <span style="color: #0805b1;"><b>l’A.C.P est la social-démocratie.</b></span> Elle désigne un courant politique qui se déclare <span style="color: #ac0306;"><b>réformiste et progressiste</b></span> tout en appliquant des idées positives de la politique libérale.
        </p>
        <p class="mini-paragraph">
            L’A.C.P opte pour des principes fondamentaux de la social-démocratie pour la concrétisation de son idéal caractérisé par :
 <span style="color: #706200;"><b>Liberté - Justice - Solidarité</b></span>
</p>
        <div class="row">
  ...
  <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877z"/>
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="#" class="footer-link">Actu</a></li>
                    <li><a href="#" class="footer-link">Rejoignez l'ACP</a></li>
    ...
    <div class="row">
        <div class="col-12 col-md-7">
            <p class="text-muted mb-0">&copy; Copyright <?= date('Y') ?></p>
            <p class="text-muted">Toutes les images sont la propriété privé de l'ACP. N’utilisez pas ces images à d'autres fin</p>
